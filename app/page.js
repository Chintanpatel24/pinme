...
export default function Home() {
  ...
  // Handle system and saved dark theme preference
  useEffect(() => {
    const savedTheme = localStorage.getItem('pinme-site-theme');
    if (savedTheme) {
  ...
  const toggleSiteTheme = useCallback(() => {
    ...
    localStorage.setItem('pinme-site-theme', nextTheme);
    ...
    <div className="container">
      <div className="theme-toggle-container">
        <button
          ...
          title={siteTheme === 'light' ? 'Switch to dark theme' : 'Switch to light theme'}
        >
          {siteTheme === 'light' ? (
        ...
        <div className="form-group">
          ...
          <div className="style-options" style={{ flexWrap: 'wrap', gap: '16px' }}>
            ...
            <label>
              ...
              />
              Show Languages Track
            </label>
            {showLangs && (
              <label style={{ marginLeft: '12px', borderLeft: '2px solid #ccc', paddingLeft: '8px' }}>
                <input
                  type="checkbox"
                  checked={langsPercentage}
                  onChange={e => setLangsPercentage(e.target.checked)}
                />
                Show Language Percentages
              </label>
            )}
          </div>
        </div>
