...
function generateCard(repo, border = false, theme = 'light', showStats = true, width = 340, height = 112, rx = 6, showSize = false, showLicense = false, showIssues = false, customBg = '', customTitle = '', customText = '', showTopics = false, showWatchers = false, showUpdated = false, showBadges = false) {
...
export function generateSingleSVG(repo, border = false, theme = 'light', showStats = true, width = 340, height = 112, rx = 6, showSize = false, showLicense = false, showIssues = false, customBg = '', customTitle = '', customText = '', showTopics = false, showWatchers = false, showUpdated = false, showBadges = false) {
  const safeWidth = Math.min(Math.max(width || 340, 200), 1000);
  const safeHeight = Math.min(Math.max(height || 112, 70), 500);
  ...
  ${generateCard(repo, border, theme, showStats, safeWidth, safeHeight, rx, showSize, showLicense, showIssues, customBg, customTitle, customText, showTopics, showWatchers, showUpdated, showBadges)}
</svg>`;
}

export function generateGridSVG(repos, cols = 2, border = false, theme = 'light', showStats = true, width = 340, height = 112, rx = 6, showSize = false, showLicense = false, showIssues = false, customBg = '', customTitle = '', customText = '', showTopics = false, showWatchers = false, showUpdated = false, showBadges = false) {
  const safeWidth = Math.min(Math.max(width || 340, 200), 1000);
  const safeHeight = Math.min(Math.max(height || 112, 70), 500);
  ...
  if (repos.length === 1) {
    return generateSingleSVG(repos[0], border, theme, showStats, safeWidth, safeHeight, rx, showSize, showLicense, showIssues, customBg, customTitle, customText, showTopics, showWatchers, showUpdated, showBadges);
  }
